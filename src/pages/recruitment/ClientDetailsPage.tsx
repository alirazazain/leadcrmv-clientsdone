...
import { ClientFiles } from '../../components/recruitment/clients/details/files/ClientFiles';
import { ClientInvoices } from '../../components/recruitment/clients/details/invoices/ClientInvoices';
...
export function ClientDetailsPage() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'files':
        return <ClientFiles client={client} onUpdate={handleUpdateClient} />;
      case 'invoices':
